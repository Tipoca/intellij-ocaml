...
public class NameParsingTest extends MLParsingTestCase {
    public void testModulePath() throws Exception {
        ...
        myTree.addNode(3, MODULE_PATH);
        myTree.addNode(4, MODULE_NAME);
        myTree.addNode(5, UCFC_IDENTIFIER, "Module1");
        myTree.addNode(4, DOT);
        myTree.addNode(4, MODULE_NAME);
        myTree.addNode(5, UCFC_IDENTIFIER, "Module2");
        myTree.addNode(4, DOT);
        myTree.addNode(4, MODULE_NAME);
        myTree.addNode(5, UCFC_IDENTIFIER, "Module3");
    ...
    public void testLabelName() throws Exception { 
        ...
        myTree.addNode(5, LABEL_DEFINITION);
        myTree.addNode(6, LABEL_NAME);
        myTree.addNode(7, LCFC_IDENTIFIER, "_label");
        myTree.addNode(5, COLON);
        myTree.addNode(5, VALUE_NAME_PATTERN);
        myTree.addNode(6, LCFC_IDENTIFIER, "a");
        myTree.addNode(4, EQ);
    ...
    public void testExtendedModulePath() throws Exception {
        myTree.addNode(2, MODULE_TYPE_DEFINITION);
        myTree.addNode(3, MODULE_KEYWORD);
        myTree.addNode(3, TYPE_KEYWORD);
        myTree.addNode(3, MODULE_TYPE_DEFINITION_BINDING);
        myTree.addNode(4, MODULE_TYPE_NAME);
        myTree.addNode(5, LCFC_IDENTIFIER, "mt");
        myTree.addNode(4, EQ);
        ...
        myTree.addNode(6, EQ);
        myTree.addNode(6, EXTENDED_MODULE_PATH);
        ...
        myTree.addNode(9, UCFC_IDENTIFIER, "Module2");
        myTree.addNode(8, PARENTHESES);
        myTree.addNode(9, LPAR);
        myTree.addNode(9, EXTENDED_MODULE_PATH);
        myTree.addNode(10, MODULE_NAME);
        myTree.addNode(11, UCFC_IDENTIFIER, "Module3");
        myTree.addNode(10, DOT);
        myTree.addNode(10, EXTENDED_MODULE_NAME);
        myTree.addNode(11, MODULE_NAME);
        myTree.addNode(12, UCFC_IDENTIFIER, "Module4");
        myTree.addNode(11, PARENTHESES);
        myTree.addNode(12, LPAR);
        myTree.addNode(12, MODULE_NAME);
        myTree.addNode(13, UCFC_IDENTIFIER, "Module5");
        myTree.addNode(12, RPAR);
        myTree.addNode(9, RPAR);
        myTree.addNode(8, PARENTHESES);
        myTree.addNode(9, LPAR);
        myTree.addNode(9, EXTENDED_MODULE_PATH);
        myTree.addNode(10, MODULE_NAME);
        myTree.addNode(11, UCFC_IDENTIFIER, "Module6");
        myTree.addNode(10, DOT);
        myTree.addNode(10, MODULE_NAME);
        myTree.addNode(11, UCFC_IDENTIFIER, "Module7");
        myTree.addNode(9, RPAR);
        myTree.addNode(7, DOT);
        myTree.addNode(7, MODULE_NAME);
    ...
    public void testModuleTypePath() throws Exception {
        ...
        myTree.addNode(5, EXTENDED_MODULE_NAME);
        myTree.addNode(6, MODULE_NAME);
        ...
        myTree.addNode(7, EXTENDED_MODULE_PATH);
        myTree.addNode(8, MODULE_NAME);
        myTree.addNode(9, UCFC_IDENTIFIER, "Module6");
        myTree.addNode(8, DOT);
        myTree.addNode(8, MODULE_NAME);
        myTree.addNode(9, UCFC_IDENTIFIER, "Module7");
        myTree.addNode(7, RPAR);
        myTree.addNode(5, DOT);
        myTree.addNode(5, MODULE_TYPE_NAME);
        myTree.addNode(6, LCFC_IDENTIFIER, "moduleType");
    ...
    public void testValueName() throws Exception {
        myTree.addNode(2, VALUE_NAME);
        myTree.addNode(3, LCFC_IDENTIFIER, "a");
        ...
        myTree.addNode(2, VALUE_NAME);
        myTree.addNode(3, LCFC_IDENTIFIER, "_a");
    ...
    private void doTestOperatorName(final IElementType operatorType, @NotNull final String operator) throws Exception {
        ...
        myTree.addNode(3, OPERATOR_NAME);
        myTree.addNode(4, operatorType, operator);
    ...
    public void testConstructorPath() throws Exception {
        myTree.addNode(2, CONSTRUCTOR_PATH);
        myTree.addNode(3, MODULE_NAME);
        myTree.addNode(4, UCFC_IDENTIFIER, "Module1");
        myTree.addNode(3, DOT);
        myTree.addNode(3, MODULE_NAME);
        myTree.addNode(4, UCFC_IDENTIFIER, "Module2");
        myTree.addNode(3, DOT);
    ...
    public void testTypeConstructorName() throws Exception {
        ...
        myTree.addNode(4, EQ);
        myTree.addNode(4, TYPE_CONSTRUCTOR_NAME);
        myTree.addNode(5, LCFC_IDENTIFIER, "_d");
    ...
    public void testClassPath() throws Exception {
        ...
        myTree.addNode(5, LCFC_IDENTIFIER, "className");
    ...
    public void testClassName() throws Exception {
        ...
        myTree.addNode(4, LCFC_IDENTIFIER, "className");
        ...
        myTree.addNode(3, NEW_KEYWORD);
        myTree.addNode(3, CLASS_NAME);
        myTree.addNode(4, LCFC_IDENTIFIER, "_className");
    ...
    public void testMethodName() throws Exception {
        ...
        myTree.addNode(4, LCFC_IDENTIFIER, "m");
        ...
        myTree.addNode(3, HASH);
        myTree.addNode(3, METHOD_NAME);
        myTree.addNode(4, LCFC_IDENTIFIER, "_m");
    ...
    public void testInstVarName() throws Exception { 
        ...
        myTree.addNode(4, LCFC_IDENTIFIER, "x");
        myTree.addNode(3, EQ);
        ...
        myTree.addNode(3, LBRACE_LT);
        myTree.addNode(3, INST_VAR_NAME);
        myTree.addNode(4, LCFC_IDENTIFIER, "_x");
        myTree.addNode(3, EQ);
        myTree.addNode(3, CONSTANT);
        myTree.addNode(4, INTEGER_LITERAL, "0");
        myTree.addNode(3, GT_RBRACE);
    ...
    public void testModuleTypeName() throws Exception {
        ...
        myTree.addNode(3, MODULE_TYPE_DEFINITION_BINDING);
        myTree.addNode(4, MODULE_TYPE_NAME);
        myTree.addNode(5, UCFC_IDENTIFIER, "M");
        myTree.addNode(4, EQ);
        myTree.addNode(4, MODULE_TYPE_NAME);
        myTree.addNode(5, UCFC_IDENTIFIER, "M");
        ...
        myTree.addNode(3, MODULE_TYPE_DEFINITION_BINDING);
        myTree.addNode(4, MODULE_TYPE_NAME);
        myTree.addNode(5, LCFC_IDENTIFIER, "_m");
        myTree.addNode(4, EQ);
        myTree.addNode(4, MODULE_TYPE_NAME);
        myTree.addNode(5, LCFC_IDENTIFIER, "_m");
    ...
    public void testTypeConstructorPath() throws Exception {
        ...
        myTree.addNode(5, LCFC_IDENTIFIER, "t");
        myTree.addNode(4, EQ);
        myTree.addNode(4, TYPE_CONSTRUCTOR_PATH);
        myTree.addNode(5, MODULE_NAME);
        myTree.addNode(6, UCFC_IDENTIFIER, "Module1");
        myTree.addNode(5, DOT);
        myTree.addNode(5, EXTENDED_MODULE_NAME);
        ...
        myTree.addNode(6, LCFC_IDENTIFIER, "typeConstr");
    ...
    public void testValuePath() throws Exception { 
        ...
        myTree.addNode(4, OPERATOR_NAME);
    ...
    public void testConstant() throws Exception {
        ...
        myTree.addNode(3, INTEGER_LITERAL, "1");
        ...
        myTree.addNode(2, CONSTANT);
        myTree.addNode(3, FLOAT_LITERAL, "1.2");
        ...
        myTree.addNode(2, CONSTANT);
        myTree.addNode(3, CHAR_LITERAL, "'w'");
        ...
        myTree.addNode(2, CONSTANT);
        myTree.addNode(3, STRING_LITERAL, "\"ww\"");
        ...
        myTree.addNode(2, CONSTANT);
        myTree.addNode(3, FALSE_KEYWORD, "false");
        ...
        myTree.addNode(2, CONSTANT);
        myTree.addNode(3, TRUE_KEYWORD, "true");
