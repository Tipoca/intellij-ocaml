...
import ocaml.lang.processing.parser.psi.element.OCamlLetClassExpression;
 ...
 *         Date: 21.03.2009
 */
public class OCamlLetClassExpressionImpl extends BaseOCamlLetExpression implements OCamlLetClassExpression {
    public OCamlLetClassExpressionImpl(@NotNull final ASTNode node) {
        super(node);
    }
    ...
    public OCamlStructuredElement findActualDefinition() {
        final OCamlClassExpression expression = OCamlPsiUtil.getLastChildOfType(this, OCamlClassExpression.class);
