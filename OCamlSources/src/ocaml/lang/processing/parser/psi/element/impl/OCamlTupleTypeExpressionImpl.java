 ...
 *         Date: 21.03.2009
 */
public class OCamlTupleTypeExpressionImpl extends BaseOCamlElement implements OCamlTupleTypeExpression {
    public OCamlTupleTypeExpressionImpl(@NotNull final ASTNode node) {
        super(node);
    }
