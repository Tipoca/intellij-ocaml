 ...
 *         Date: 21.03.2009
 */
public class OCamlFunctorModuleExpressionImpl extends BaseOCamlElement implements OCamlFunctorModuleExpression {
    public OCamlFunctorModuleExpressionImpl(@NotNull final ASTNode node) {
        super(node);
    }
    ...
    public OCamlStructuredElement findActualDefinition() {
        final OCamlModuleExpression expression = OCamlPsiUtil.getLastChildOfType(this, OCamlModuleExpression.class);
