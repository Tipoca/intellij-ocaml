 ...
 *         Date: 21.03.2009
 */
public class OCamlParameterImpl extends BaseOCamlResolvedReference implements OCamlParameter {
    ...
    public ASTNode getNameElement() {
        final ASTNode labeledParameter = OCamlASTTreeUtil.checkNodeType(getNode().getFirstChildNode(), OCamlElementTypes.LABEL_DEFINITION);
        if (labeledParameter == null) return null;
        return OCamlASTTreeUtil.findChildOfType(labeledParameter, OCamlElementTypes.VALUE_NAME, true, OCamlTokenTypes.EQ);
    }
