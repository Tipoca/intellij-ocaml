...
public class OCamlValueNameImpl extends BaseOCamlReference implements OCamlValueName {
    ...
    public List<Class<? extends OCamlResolvedReference>> getPossibleResolvedTypes() {
        return Arrays.asList(OCamlExternalDefinition.class, OCamlObjectSelfDefinition.class,
            OCamlValueSpecification.class, OCamlValueClassFieldDefinition.class, OCamlValueNamePattern.class,
            OCamlValueClassFieldSpecification.class, OCamlInheritClassFieldDefinition.class,
            OCamlForExpressionIndexVariableName.class);
    }
