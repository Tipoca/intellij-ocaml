 ...
 *         Date: 21.03.2009
 */
public class OCamlClassSpecificationBindingImpl extends BaseOCamlResolvedReference implements OCamlClassSpecificationBinding {
    public OCamlClassSpecificationBindingImpl(@NotNull final ASTNode node) {
        super(node);
    }
