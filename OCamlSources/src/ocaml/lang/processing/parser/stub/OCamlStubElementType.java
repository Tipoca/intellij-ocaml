...
public class OCamlStubElementType<Stub extends OCamlStubElement<Psi>, Psi extends OCamlElement> extends IStubElementType<Stub, Psi> {
    ...
    public void serialize(final Stub stub, final StubOutputStream dataStream) throws IOException {
        //To change body of implemented methods use File | Settings | File Templates.
    }

    public Stub deserialize(final StubInputStream dataStream, final StubElement parentStub) throws IOException {
        return null;  //To change body of implemented methods use File | Settings | File Templates.
    }
